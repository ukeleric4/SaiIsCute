...
public class TwoWheelLocalizer extends Localizer { // todo: make two wheel odo work
    ...
    public static double FORWARD_TICKS_TO_INCHES = -0.0029811403078306427;
    public static double STRAFE_TICKS_TO_INCHES = -0.0029811403078306427;
    ...
    public TwoWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoderPose = new Pose(0, -6, 0);
        strafeEncoderPose = new Pose(6, 1.5, Math.toRadians(90));
        ...
        forwardEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "bl"));
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "br"));

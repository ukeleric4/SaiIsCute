...
public class FollowerConstants {
    ...
    private static double xMovement = 57.3919;
    private static double yMovement = 44.0192;
    ...
    public static double forwardZeroPowerAcceleration = -35.05356773902818;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -77.71579875296749;
    ...
    public static double zeroPowerAccelerationMultiplier = 4.2;

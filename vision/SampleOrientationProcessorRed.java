...
public class SampleOrientationProcessorRed implements VisionProcessor {
    ...
    public SampleOrientationProcessorRed(Telemetry telemetry) {
...
//        Imgproc.dilate(inRange, inRange, kernel2);
        ...
        if (!filteredRects.isEmpty()) {
            ...
            if (sampleAngle >= -90 && sampleAngle <= -45) {
                servoPosition = 0.5 + (0.75 - 0.5) * (sampleAngle + 90) / 45;
            } else if (sampleAngle > -45 && sampleAngle <= 0) {
                servoPosition = 0.75 + (1 - 0.75) * (sampleAngle + 45) / 45;
            } else if (sampleAngle > 0 && sampleAngle <= 45) {
                servoPosition = 0 + 0.25 * sampleAngle / 45;
            } else if (sampleAngle > 45 && sampleAngle <= 90) {
                servoPosition = 0.25 + (0.5 - 0.25) * (sampleAngle - 45) / 45;
            }
        } else {
            servoPosition = 1.0;
        }

...
public class SampleOrientationProcessorBlue implements VisionProcessor {
    ...
    public RectDrawer.SampleColor colorType = RectDrawer.SampleColor.BLUE;

    private ArrayList<RotatedRect> rects;

    public SampleOrientationProcessorBlue(Telemetry telemetry) {
